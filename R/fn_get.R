    ...
    datasets_ls <- datasets_ls %>% purrr::map2(names(datasets_ls), 
        ~{
            index_1L_int <- switch(.y, appointments = appointments_rows_1L_int, 
                referrals = referrals_rows_1L_int, cancellations = cancellations_rows_1L_int, 
                retainer = retainer_rows_1L_int, neuropsychological = neuropsychological_rows_1L_int, 
