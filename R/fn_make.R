...
#' @keywords internal
make_sports_groups <- function (datasets_ls, categories_chr = c("Risky", "Subjective", 
    "Team", "Type", "Weighed", "Winter"), simple_1L_lgl = TRUE) 
{
...
#' @importFrom tidyselect all_of
#' @keywords internal
make_sports_tb <- function (datasets_ls, categories_chr = c("Risky", "Subjective", 
